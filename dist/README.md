...
|ChatGPT|6|<li>通知提示-充值Plus提示<li>功能类-ban话题提前阻断屏蔽<li>局部广告<li>通知提示-聊天记忆容量警告<li>功能类-自动打开联网查询<li>功能类-上传/发送错误自动重试|
...
|百度贴吧|12|<li>开屏广告<li>权限提示-通知权限<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片广告<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮小广告<li>局部广告-[帖子内/吧内]底部悬浮窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-帖子底部话题卡片<li>全屏广告-会员弹窗<li>局部广告-感兴趣的吧推广|
...
|抖音极速版|7|<li>功能类-功能体验邀请弹窗<li>全屏广告-朋友推荐弹窗<li>权限提示-通知权限<li>功能类-选择图片时自动勾选原图<li>全屏广告<li>全屏广告-添加桌面小组件<li>功能类-刷到推广视频时[上滑]|
...
|快手极速版|6|<li>开屏广告<li>全屏广告-朋友推荐弹窗<li>全屏广告-红包弹窗<li>分段广告-悬浮广告<li>评价提示<li>功能类-刷到推广视频时[上滑]|
|快牙|1|<li>局部广告-卡片广告|
|岚图汽车|1|<li>功能类-自动签到|
|蓝岛|1|<li>通知提示-通知弹窗|
|懒懒视频|1|<li>全屏广告-弹窗广告|
...
|汽水音乐|10|<li>开屏广告<li>更新提示<li>全屏广告-VIP弹窗<li>功能类-全自动看广告领VIP<li>功能类-看广告自动[静音]<li>评价提示-评分弹窗<li>局部广告-悬浮窗广告<li>其他-关闭[更多直播]推荐<li>功能类-全自动看广告领VIP_单日<li>局部广告-抖音看过视频提示浮窗|
...
|食卡卡|2|<li>开屏广告<li>其他-开屏误触后的返回操作|
|视趣|1|<li>全屏广告-弹窗广告|
...
|X(推特)|14|<li>分段广告-主页信息流广告<li>分段广告-帖子详情页、搜索页信息流广告<li>分段广告-用户资料页信息流广告<li>评价提示<li>权限提示-通知权限<li>功能类-自动点击翻译<li>功能类-自动点击[显示更多帖子]<li>其他-关闭[开启个性化广告]弹窗<li>功能类-自动显示可能的垃圾信息<li>功能类-[保存]图片帖子<li>功能类-网络错误自动重试<li>功能类-进入视频自动静音<li>功能类-查看潜在敏感内容的个人页面<li>局部广告-账号详情-小蓝标认证|
|ZK助手|1|<li>全屏广告-弹窗广告|
