...
|抖音极速版|9|<li>功能类-功能体验邀请弹窗<li>全屏广告-朋友推荐弹窗<li>权限提示-通知权限<li>功能类-选择图片时自动勾选原图<li>全屏广告<li>全屏广告-添加桌面小组件<li>功能类-刷到推广视频时[上滑]<li>局部广告-商品卡片<li>分段广告-搜索结果页广告|
...
|快手极速版|7|<li>开屏广告<li>全屏广告-朋友推荐弹窗<li>全屏广告-红包弹窗<li>分段广告-悬浮广告<li>评价提示<li>功能类-刷到推广视频时[上滑]<li>局部广告-用户资料页广告|
|快牙|1|<li>局部广告-卡片广告|
|岚图汽车|1|<li>功能类-自动签到|
|蓝岛|1|<li>通知提示-通知弹窗|
|懒懒视频|1|<li>全屏广告-弹窗广告|
