...
[![已适配应用](https://img.shields.io/badge/已适配应用-931-brightgreen)](./dist/README.md#应用规则)
[![全局规则组](https://img.shields.io/badge/全局规则组-3-blueviolet)](./dist/README.md#全局规则)
[![应用规则组](https://img.shields.io/badge/应用规则组-2241-orange)](./dist/README.md#应用规则)
...
<!-- > 当前版本: v472
> 
> 当前订阅文件已适配 931 个应用，共有 2241 应用规则组，3 全局规则组
> 
